...
export const CATALOG: CatalogCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'bookcase-open', name: 'Estante Livreiro Aberta', w: 0.9, d: 0.35, h: 1.9, by: 0, pr: 'fr', modelUrl: '/models/bookcaseOpen.glb', dm: { t: 'wood', c: '#5c4033' } },
      { id: 'bookcase-closed', name: 'Estante Livreiro com Portas', w: 0.9, d: 0.38, h: 1.9, by: 0, pr: 'fr', modelUrl: '/models/bookcaseClosedDoors.glb', dm: { t: 'wood', c: '#3a3a3a' } },
      { id: 'bookcase-wide', name: 'Estante Multiuso Larga', w: 1.4, d: 0.35, h: 1.9, by: 0, pr: 'fr', modelUrl: '/models/bookcaseClosedWide.glb', dm: { t: 'wood', c: '#ffffff' } },
    ],
  },
  {
    id: 'bedroom',
    ...
    items: [
      ...
      { id: 'wardrobe-doors', name: 'Guarda-Roupa 2 Portas', w: 1.2, d: 0.6, h: 2.1, by: 0, pr: 'fr', modelUrl: '/models/bookcaseClosedDoors.glb', dm: { t: 'wood', c: '#5c4033' } },
      { id: 'wardrobe-wide', name: 'Guarda-Roupa Casal Amplo', w: 1.8, d: 0.6, h: 2.1, by: 0, pr: 'fr', modelUrl: '/models/bookcaseClosedWide.glb', dm: { t: 'wood', c: '#ffffff' } },
